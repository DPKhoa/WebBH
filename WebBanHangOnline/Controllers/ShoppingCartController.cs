        ...
        {
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (cart != null)
                    {
                        ...
                        order.Status = 1;// chưa thanh toán, 2 đã thanh toán, 3 hoàn thành đơn đã giao, 4 là hủy
                        ...
                        WebBanHangOnline.Models.common.Common.SendMail("ShopOnline", "Đơn hàng #" + order.Code, contentCustomer.ToString(), req.Email);
                        //cart.ClearCart();
                        ...
                        WebBanHangOnline.Models.common.Common.SendMail("ShopOnline", "Đơn hàng mới #" + order.Code, contentAdmin.ToString(), ConfigurationManager.AppSettings["EmailAdmin"]);
                        cart.ClearCart();
